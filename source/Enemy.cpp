...
Enemy::Enemy(u32 x, u32 y, u8 radius, Level* level, u8 entityNum) : Entity(x, y, radius, level), _entityNum(entityNum) {
	...
	_attributeObj->attr2 = 16 | OBJ_PRIORITY(0) | OBJ_PALETTE(0);
